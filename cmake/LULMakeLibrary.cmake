#[[#############################################################################
	...
	This file is modified from QuickCppLibMakeLibrary.cmake in
...
if(NOT DEFINED ${PROJECT_NAME}_HEADERS)
  message(FATAL_ERROR "FATAL: LULSetupProject has not been included yet.")
endif()
if(NOT DEFINED ${PROJECT_NAME}_SOURCES)
  message(FATAL_ERROR "FATAL: Cannot include LULMakeLibrary without a src directory. "
                      "Perhaps you meant LULMakeHeaderOnlyLibrary?")
endif()
